...
const seedDatabase = async () => {
  try {
    ...
    // Insert new data
    await PersonalInfo.create(dummyData.personalInfo);
    await Skills.create(dummyData.skills);
    await Project.insertMany(dummyData.projects);
    await Achievement.insertMany(dummyData.achievements);
    await Education.insertMany(dummyData.education);
    await Experience.create(dummyData.experience);
